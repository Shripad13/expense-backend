...
echo "Authenticating to EKS Dev"
...
arcgocd app create backend --repo https://github.com/Shripad13/expense-helm.git --path .  --dest-namespace default --dest-server https://kubernetes.default.svc --values ${1}/backend.yaml

#echo "Creating Dev Frontend app"
#arcgocd app create frontend --repo https://github.com/Shripad13/expense-helm.git --path .  --dest-namespace default --dest-server https://kubernetes.default.svc --values ${1}/frontend.yaml